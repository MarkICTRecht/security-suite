...
> **Distribution note:** Live runnable samples were removed from this skill for safe distribution. See `NOTICE.md` in this folder and pull originals from upstream SecLists only for authorized lab use.
